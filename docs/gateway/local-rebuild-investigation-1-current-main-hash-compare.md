...
This checkpoint records a fresh local rebuild from current main after Read-only Network Precheck Execution.1 found a live testnet hash mismatch.

This checkpoint is local-only.
...
current_main_commit: bcaa206d5f3cfc62ad209da8e1414021813f1a98

current_main_short: bcaa206d5f3c

## Hash comparison result

~~~text
build_status=0
old_expected_hash=e68ada36e1914584c2dcc186afbdfcba608b286fc2cd404015a7a8c28764daa1
observed_live_hash=fd4d3b659ccaea4f5e24eca4d9e80ff808c43de1bf1ecef7315961751a085a7e
observed_hash_now=fd4d3b659ccaea4f5e24eca4d9e80ff808c43de1bf1ecef7315961751a085a7e
fresh_local_hash=e68ada36e1914584c2dcc186afbdfcba608b286fc2cd404015a7a8c28764daa1
fresh_local_size=20840
observed_live_size=38584
...
This local rebuild investigation does not approve:
- RPC
- testnet calls
- ProgramData reads
- executable bytes dumps from network
...
investigation_result: FRESH_REBUILD_MATCHES_OLD_EXPECTED_LIVE_TESTNET_BINARY_DIFFERS

classification_hint: LIVE_TESTNET_BINARY_DIFFERENT_STALE_OR_UNKNOWN
