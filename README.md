...
The next recommended step is Stage 1.7 X1 account/storage layout review, followed by staging/runtime, gateway-risk review, and X1-native model review before adding new protocol features or Build actor scope.
